...
public class LogicExercise {
	...
	/**
	 * Takes a BigDecimal for the unit price and an integer for number of
     ...
     * the array containing an even number of letters, and then return the
     * result. For example, if given an array of "Cat", "Dog", "Bird", the method
     * should return an array containing only "Cat" and "Dog".
     */
	...
	/**
	 * This method should take an double array, a, and return a 
     * new array containing the square of each element in a.	 *
	 */
	...
	/**
	 * This method should take an int array, a, and return 
     * the index of the element with the greatest value.
	 */
    ...
    /**
     * This method should take an ArrayList of Integers, a, and return true if all
     * elements in the ArrayList are divisible by the given integer, i.
     */
    public boolean isDivisibleBy(int i, ArrayList<Integer> a) {
    ...
    /**
     * This method should take a string and return a HashMap which maps the indexs
     * of each character occurring in a string (i.e., which characters occur where in a
     * string). For example for the string "Hello World", the map would look
